...
class AppStyle {
  TextStyle headline1Theme() =>
      TextStyle(fontWeight: FontWeight.w600, color: AppColor.black, fontSize: 26.sp);
  ...
  TextStyle headline3Theme() => TextStyle(
      fontSize: 15.8.sp, fontWeight: FontWeight.bold, color: AppColor.pineGreen);
  ...
  TextStyle headline6Theme() => TextStyle(
      fontSize: 12.4.sp, fontWeight: FontWeight.w600, color: AppColor.primaryColor);
  ...
  TextStyle subtitle1Theme() => TextStyle(
      fontSize: 12.4.sp, fontWeight: FontWeight.w300, color: AppColor.pineGreen);

  TextStyle subtitle2Theme() =>
      TextStyle(fontSize: 12.sp, fontWeight: FontWeight.w400, color: AppColor.subTitleColor);

  TextStyle overLineTheme() => TextStyle(
      fontSize: 10.5.sp, fontWeight: FontWeight.w300, color: AppColor.subTitleColor);
  ...
  TextStyle appBarTitleTextStyle() => TextStyle(
      fontSize: 16.sp, fontWeight: FontWeight.bold, color: AppColor.primaryColor);
