                ...
                children: [
                  Expanded(
                    child: ConfirmPayingExpense(
                      date:
                          formatDayDate(DateTime.now(), translator.activeLanguageCode),
                      ...
                      onEditAmount: () {
                        ...
                        newAmountDialog(
                            ...
                            onUpdate: () {
                              ...
                              currentIncome.amount = changedAmount.text.toDouble();
                            },
                            context: context,
                      ...
                      index: index,
                      onCancel: () {
                        confirmCubit.onNoConfirmed(theAddedExpense: currentIncome);
                      },
                      onConfirm: () {
                        confirmCubit.onYesConfirmed(theAddedExpense: currentIncome);
                      },
                    ),
                  ),
                  SizedBox(width: 4.w),
              ...
              return Row(
                children: [
                  Expanded(
                    child: ConfirmPayingExpense(
                      date: formatDayDate(
                          currentExpense.createdDate, translator.activeLanguageCode),
                      ...
                      onEditAmount: () {
                        ...
                        newAmountDialog(
                            ...
                            onUpdate: () {
                              ...
                              currentExpense.amount = double.parse(changedAmount.text);
                            },
                            context: context,
                            changedAmountCtrl: changedAmount);
                      },
                      index: index,
                      onCancel: () =>
                          confirmCubit.onNoConfirmed(theAddedExpense: currentExpense),
                      onConfirm: () =>
                          confirmCubit.onYesConfirmed(theAddedExpense: currentExpense),
                      // changedAmount: 10000,
                      // blockedAmount: 20000,
                      // onEditBlockedAmount: () {},
                      // onEditChangedAmount: () {},
