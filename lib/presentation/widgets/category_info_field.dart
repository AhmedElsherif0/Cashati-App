...
class CategoryInfoField extends StatefulWidget {
  const CategoryInfoField({Key? key,required this.mainCategoryName}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Padding(
        ...
        child: ListTile(
          title: Text(widget.mainCategoryName,style: Theme.of(context).textTheme.bodyText2!.copyWith(fontWeight: FontWeight.w300),),
